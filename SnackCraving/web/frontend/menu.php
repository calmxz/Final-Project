    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <table id="product-table" class="w-full text-sm text-left text-gray-900">
            <thead class="text-xs text-gray-700 uppercase bg-gray-200">
                <tr>
                    <th scope="col" class="hidden px-6 py-3" data-column="product_id">
                        ID
                    </th>
                    <th scope="col" class="px-6 py-3" data-column="product_name">
                        Product name 
                    </th>
                    <th scope="col" class="px-6 py-3" data-column="product_category">
                        Category
                    </th>
                    <th scope="col" class="px-6 py-3" data-column="price">
                        Price
                    </th>
                    <th scope="col" class="px-6 py-3" data-column="stock_quantity">
                        Stock Quantity 
                    </th>
                    <th scope="col" class="px-6 py-3" data-column="food_status">
                        Status 
                    </th>
